...
openVFS :: Monad m => VFS -> J.DidOpenTextDocumentNotification -> m VFS
...
changeFromClientVFS :: Monad m => VFS -> J.DidChangeTextDocumentNotification -> m VFS
...
closeVFS :: Monad m => VFS -> J.DidCloseTextDocumentNotification -> m VFS
